...
export function configuredReviewPromptPath(config, repo) {
  const target = Array.isArray(config?.pollTargets)
...
export async function ensureReviewPrompt(repo, { templatePath, seedPath }) {
